...
function Register() {
  ...
  return (
    <div className="flex w-full h-full justify-center items-center px-4 sm:px-0">
      <Card
        className="flex w-full sm:w-5/6 md:w-4/6 h-5/6 sm:h-4/6 shadow-xl border justify-center p-2 px-12 sm:px-2 rounded-none"
        style={{
      ...
      >
        <div className="flex flex-col gap-4 w-full sm:w-5/6 h-full justify-center items-center text-start bg-white/80 p-4">
